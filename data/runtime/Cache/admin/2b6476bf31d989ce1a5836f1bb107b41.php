...
<div class="pad_lr_10" >
    ...
    <div class="J_tablelist table_list" data-acturi="<?php echo U('brand/ajax_edit');?>">
    <table width="100%" cellspacing="0">
        <thead>
            <tr>
                ...
                <th align="left"><span data-tdtype="order_by" data-field="name">品牌名称</span></th>
                <th align="left"><span data-tdtype="order_by" data-field="url">品牌地址</span></th>
    	...
    	<tbody>
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
				...
				<img src="<?php echo ($img_dir); echo ($val["img"]); ?>" style="width:26px; height:26px;" />
				</span></notempty>
				</td>
                ...
                <td align="center">
					<a href="javascript:;" class="J_showdialog" data-uri="<?php echo U('brand/edit', array('id'=>$val['id']));?>" data-title="<?php echo L('edit');?> - <?php echo ($val["name"]); ?>"  data-id="edit" data-acttype="ajax" data-width="500" data-height="260"><?php echo L('edit');?></a> |
                    <a href="javascript:;" class="J_confirmurl" data-acttype="ajax" data-uri="<?php echo U('brand/delete', array('id'=>$val['id']));?>" data-msg="<?php echo sprintf(L('confirm_delete_one'),$val['name']);?>"><?php echo L('delete');?></a>
					</td>
	...
	<div class="btn_wrap_fixed">
    	...
    	<input type="button" class="btn" data-tdtype="batch_action" data-acttype="ajax" data-uri="<?php echo U('brand/delete');?>" data-name="id" data-msg="<?php echo L('confirm_delete');?>" value="<?php echo L('delete');?>" />
