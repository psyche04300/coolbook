...
class userModel extends Model
{
    ...
    public function is_msg_notification($uid) {
        $is_msg_notification = $this->field('is_msg_notification')->where(array('id'=>$uid))->getField('is_msg_notification');
        if ($is_msg_notification===1) {
            return true;
        } else {
            return false;
        }
